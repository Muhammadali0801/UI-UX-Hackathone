...
export default function header() {
  return (
    ...
    <div className="bg-[#F5F5F5] flex justify-between items-center px-6 py-2 md:text-[11px] sm:text-[9px] text-[8px] font-medium text-gray-500">
      <Image
       src= "/men-logo.png"
        alt={'men-logo'} width={24} height={24}
        className="w-[24px] h-[24px]"/>
      
      <div className="flex md:gap-4 sm:gap-3 gap-2">
        <Link href="#" className="hover:text-gray-800">Find Link Store <span className="px-3">|</span></Link>
        <Link href="#" className="hover:text-gray-800">Help <span className="px-3">|</span></Link>
        <Link href="#" className="hover:text-gray-800">Join Us <span className="px-3">|</span></Link>
